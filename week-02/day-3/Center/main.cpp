...
void linedrawer(int x, int y)
{
    for (int i = 0; i < 3; ++i) {
        SDL_SetRenderDrawColor(gRenderer, 10*i, 100*i, i, 0xFF);
        SDL_RenderDrawLine(gRenderer, x-100+100*i, x-100+100*i, SCREEN_WIDTH/2, SCREEN_HEIGHT/2);
    }
